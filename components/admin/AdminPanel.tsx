            ...
            <nav className="w-full md:w-20 lg:w-64 bg-[#0a0a0a] border-b md:border-b-0 md:border-r border-white/5 flex md:flex-col items-center md:items-start p-4 md:py-8 sticky top-0 z-50">
                ...
                <div className="flex md:flex-col w-full justify-around md:justify-start gap-2">
                    <button
                        ...
                        className={`p-3 md:px-4 md:py-3 rounded-xl flex items-center space-x-3 transition-all ${activeTab === 'dashboard' ? 'bg-amber-500 text-black' : 'text-white/50 hover:bg-white/5 hover:text-white'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`p-3 md:px-4 md:py-3 rounded-xl flex items-center space-x-3 transition-all ${activeTab === 'bookings' ? 'bg-amber-500 text-black' : 'text-white/50 hover:bg-white/5 hover:text-white'
                            }`}
                    >
