...
import { ChevronLeft, MapPin, Map, ArrowRight } from 'lucide-react';
        ...
        {loading ? (
          ...
          branches.map((branch, index) => (
            <motion.div
              ...
              className="group cursor-pointer relative overflow-hidden rounded-3xl bg-[#121212] border border-white/5 hover:border-amber-500/30 transition-all duration-300 p-1"
            >
              {/* Main Content Area */}
              <div className="p-5 relative z-10">
                ...
                <div className="flex items-center justify-between mt-2">
                    ...
                    >
                        ...
                        <span className="text-xs font-semibold text-white/80 group-hover/map:text-white">Ver Mapa</span>
                    </button>
