...
export const Confirmation: React.FC = () => {
  ...
  const handleBooking = async () => {
    ...
    // 1. If new user, register in DB (mocked inside supabaseApi.createBooking implicitly or explicitly)
    if (client && client.ranking === 'nuevo') {
      await bookingService.createClient(client.celular, client.nombre_completo);
    }
